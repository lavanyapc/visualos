import { PageReplacementAlgorithm } from '../algorithms/pageReplacement'

const OPTIONS: { value: PageReplacementAlgorithm; label: string }[] = [
...
interface Props {
  ...
  onChange: (a: PageReplacementAlgorithm) => void
}

export default function PageReplacementAlgorithmSelector({ value, onChange }: Props) {
  return (
